...
import { Key, Cpu, Globe, Save, Eye, EyeOff, Check, AlertCircle } from 'lucide-react';
        ...
        <Card>
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Connect to OpenRouter and Zenrio</p>
            </div>
          </div>
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  {isConfigured
                    ...
                    : 'Please configure both OpenRouter and Zenrio API keys to use the application.'}
                </p>
              </div>
            </div>
